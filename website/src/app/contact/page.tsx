...
export const metadata: Metadata = {
  title: 'Contact',
  description: 'Contactez l’équipe FACTEO pour toute question commerciale ou support technique.',
};
        ...
        <div className="mx-auto grid max-w-4xl gap-8 md:grid-cols-2">
          <FadeIn>
            <div className="card-hover rounded-2xl border border-border bg-surface p-8">
              ...
              <p className="mt-2 text-sm text-muted">Questions sur les offres, démonstrations, partenariats.</p>
