/**
 * Configuration centralisée des offres FACTEO (prix HT, limites, fonctionnalités).
...
/**
 * Matrice produits réelle FACTEO (uniquement ce qui est disponible aujourd’hui).
...
export const SUBSCRIPTION_PLANS: SubscriptionPlan[] = [
  {
    id: 'micro',
    name: 'Micro',
    description: 'Pour découvrir FACTEO et facturer vos premiers clients.',
    priceMonthlyHt: 0,
