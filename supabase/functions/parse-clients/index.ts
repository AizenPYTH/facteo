  ...
  try {
    ...
    const modelOutput = await requestOpenAiJsonSchema({
      ...
      systemPrompt: [
        ...
        'Identité client : une entreprise seule est valide ; sinon renseigne nom ET prénom.',
        'Ne fabrique pas de nom de personne si seule une société est présente (laisse firstName/lastName vides).',
        'Sépare prénom et nom quand c’est possible. Si un seul nom de personne est donné (sans entreprise), mets-le dans lastName.',
